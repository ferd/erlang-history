...
I've tested it with all *quarterly* versions from R13B04 up to 19.1. It worked fine for them. I plan on supporting all newer *quarterly* versions. ALL OF THEM.
